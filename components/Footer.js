...
export default function Footer() {
  ...
  return (
    <footer className={`bg-gradient-to-t from-purple-900/30 to-black border-t border-purple-800/50 ${hideNewsletter ? 'mt-12' : ''}`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        {/* Newsletter Subscription - Hidden on profile and blog pages */}
        {!hideNewsletter && (
          <div className="mb-12 pb-12 border-b border-purple-800/50">
            <BrevoFormEmbed />
          </div>
        )}
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-400 max-w-md mb-4">
              Decentralized GPS app crowdsourcing live traffic, incident reports & anonymized data. Navigate smarter, earn rewards!
            </p>
            <a 
              href="mailto:hello@capturgo.com"
          ...
          <div>
            ...
            <div className="space-y-2">
              <Link href="/#discover" className="block text-gray-400 hover:text-white transition-colors">
                Discover
              </Link>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <a 
                href="https://www.instagram.com/capturgo/" 
                target="_blank" 
                rel="noopener noreferrer"
                className="flex items-center space-x-2 text-gray-400 hover:text-white transition-colors"
              >
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center">
          <p className="text-gray-400">
            © 2025 capturGO. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
